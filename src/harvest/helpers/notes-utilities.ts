 ...
 * @param {string} multiLineString the notes field of a Harvest time entry.
 * @returns {RegExpMatchArray | []} an array of matched lines.
 */
export const splitLines = (multiLineString: string): RegExpMatchArray | [] => multiLineString.match(/[^\r\n]+/g) || [];

/**
 * Strip out the given prefix from the incoming line [note: method badly named and will be changed].
 * @param {string} line the incoming line with the expected prefix.
 ...
 * @param {string[]} lines the incoming list of lines.
 ...
 * @param {string[]} lines the incoming list of lines.
 * @param {string[]} prefixes the list of prefixes to search for.
