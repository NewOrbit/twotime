...
describe("findPrefixInLines", () => {
    ...
    const cases: [lines: string[], prefix: string, expected: string | null][] = [
        [["> a somevalue", "anothervalue", "> apple oranges pears"], "> apple ", "oranges pears"],
        [["& bla bla bla", "&& bla foo foo", "#john smith"], "& bla ", "bla bla"],
        [["> user_story #12345 foo", "> task #18273 this is a task", "> finished"], "> user_story #", "12345 foo"],
        [["> user_story #12345 foo", "> task #18273 this is a task", "> finished"], "> finished", ""],
        [["@ 1234", "### 198318", "~~~ +-123", "$&$!*"], "> finished", null],
    ];
